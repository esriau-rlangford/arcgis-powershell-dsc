...
function Get-TargetResource
{
    ...
    (
        ...
        [System.Boolean]
        $FileShareCredentialIsDomainAccount = $false,
...
function Set-TargetResource
{
    ...
    $fsusername = $FileShareCredential.UserName
    if(-not($FileShareCredentialIsDomainAccount)) {
    ...
    Write-Verbose "Using username $fsusername to connect to file share"
    ...
    if($UseAzureFiles){
        ...
        Write-Verbose "connectTestResult - $($connectTestResult.TcpTestSucceeded)"
